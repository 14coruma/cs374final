...
void testShiftRight() {
	...
	cubi_set_str(a, (char*) "46");
	cubi_set_str(b, (char*) "23");
	cubi_shift_right(a);
	assert(cubi_cmp(a, b) == 0);
	fprintf(stderr, "✔\n");

	fprintf(stderr, "  + Shift medium length even cubi right... ");
	cubi_set_str(a, (char*) "4664364634");
	cubi_set_str(b, (char*) "2332182317");
	cubi_shift_right(a);
	assert(cubi_cmp(a, b) == 0);
	fprintf(stderr, "✔\n");

	fprintf(stderr, "  + Shift large length even cubi right... ");
	cubi_set_str(a, (char*) "34987234978234");
	cubi_set_str(b, (char*) "17493617489117");
	cubi_shift_right(a);
	assert(cubi_cmp(a, b) == 0);
	fprintf(stderr, "✔\n");

	fprintf(stderr, "  + Shift even Larger even cubi right... ");
	cubi_set_str(a, (char*) "23872435098723450982345084352");
	cubi_set_str(b, (char*) "11936217549361725491172542176");
	cubi_shift_right(a);
	assert(cubi_cmp(a, b) == 0);
	fprintf(stderr, "✔\n");

	fprintf(stderr, "  + Shift even Larger even cubi right... ");
	cubi_set_str(a, (char*) "437684350872345089723459083245987234598723458978");
	cubi_set_str(b, (char*) "218842175436172544861729541622993617299361729489");
	cubi_shift_right(a);
	assert(cubi_cmp(a, b) == 0);
	fprintf(stderr, "✔\n");
